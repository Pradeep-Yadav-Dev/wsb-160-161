...
export default function Header() {
    return (
        ...
        <nav className="bg-[#ccc] border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#ccc] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar" className="z-10 hidden font-normal bg-[#ccc] divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
