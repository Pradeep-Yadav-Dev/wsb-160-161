                          ...
                          <>
                            <tr className="bg-white  dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <div className="py-4">
                                  <div className="text-base font-semibold"> {v.categoryName} </div>

                                </div>
                              </th>
                              <td className=" py-4">
                                <img className="w-10 h-10 rounded-full" src={filePath + v.parentCategoryImage} alt="Jese image" />
                              </td>
                              <td className=" py-4">
                                {v.order}
                              </td>
                              <td className=" py-4">
                                ...
                                {v.status == true ?
                                  ...
                                  :
                                  <button type="button" className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-1.5 text-center me-2 mb-2">Inactive</button>
                                }
                              </td>
                              <td className=" py-4">
